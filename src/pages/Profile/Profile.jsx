    ...
    <Dialog open={open} onClose={setOpen} className="relative z-10">
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          >
            <div className=" px-4 pb-4 pt-5 sm:p-6 sm:pb-4 bg-color3 text-color4">
              <div className="sm:flex sm:items-start">
                <div className="mx-auto flex size-12 shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:size-10">
                  <IoLogOut aria-hidden="true" className="size-6 text-red-600 text-color0" />
                </div>
            ...
            <div className="bg-color3 text-color4 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button
